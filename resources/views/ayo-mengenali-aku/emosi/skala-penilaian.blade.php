        ...
        <div class="space-y-6 md:p-4 rounded-2xl  lg:mx-auto mx-5 mt-5 ">
            ...
            @isset($revisi_materi['jawaban_instrumen'])
                <x-congratulations-card title="Selamat!" message="Kamu telah menyelesaikan:"
                    subtitle="Penilaian Capaian Pembelajaran : Emotional Awareness dengan nilai {{ $revisi_materi['jawaban_instrumen']['score'] }}" stars="{{ $stars }}"
        ...
        @push('custom-script')
            <script>
                $('#form-instrumen-jauhi-narkoba').submit(function(e) {
                    ...
                    axios.post("{{ route('emotional-awareness.update', ['emotional_awareness' => 1]) }}", {
                            data: jawaban,
                            _method: 'PUT',
                            _token: '{{ csrf_token() }}'
                        })
