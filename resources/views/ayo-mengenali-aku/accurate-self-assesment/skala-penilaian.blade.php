...
@foreach ($acc_self_as as $studi)
    @if ($studi['nama'] === 'skala penilaian asa')
        ...
        <div class="md:flex font-poppins font-Poppins">
            ...
            <div class="space-y-6 md:p-4 rounded-2xl  lg:mx-auto md:mx-5 mt-5 ">
                                ...
                                <dl>
                                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <dd class="mt-1  text-gray-900 sm:mt-0 sm:col-span-2">
                                            Baca setiap pernyataan dengan cermat. Anda diminta untuk menilai diri
                                            sendiri
                                    ...
                                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <dd class="mt-1  text-gray-900 sm:mt-0 sm:col-span-2">
                                            ...
                                            <ul class="list-disc pl-5 mt-2">
                                                <li><span class="font-semibold">1 (Sangat Tidak Setuju):</span> Anda
                                                    merasa
                                                    pernyataan tersebut sama sekali tidak menggambarkan diri Anda</li>
                                                <li><span class="font-semibold">2 (Tidak Setuju):</span> Anda merasa
                                                    pernyataan
                                                    tersebut hanya sedikit menggambarkan diri Anda</li>
                                                <li><span class="font-semibold">3 (Setuju):</span> Anda merasa
                                                    pernyataan
                                                    tersebut
                                                    cukup menggambarkan diri Anda</li>
                                                <li><span class="font-semibold">4 (Sangat Setuju):</span> Anda merasa
                                                    pernyataan
                                    ...
                                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <dd class="mt-1  text-gray-900 sm:mt-0 sm:col-span-2">
                                            Pastikan semua pernyataan telah dijawab. Tidak ada jawaban benar atau salah,
                                            jawablah
                ...
                @php
                    $score = $studi['jawaban_instrumen']['score'] ?? 0;
                ...
                @isset($studi['jawaban_instrumen'])
                    <x-congratulations-card title="Selamat!" message="Kamu telah menyelesaikan:"
                        subtitle="Penilaian Capaian Pembelajaran : Emotional Awareness dengan nilai {{ $studi['jawaban_instrumen']['score'] }}"
                        stars="{{ $stars }}" footer="{{ $studi['jawaban_instrumen']['message'] }}" />
                @endisset
                ...
                <div class="indent-7 space-y-3">
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-md max-w-4xl w-full">
                        ...
                        <form method="POST" action="#" id="form-instrumen-accurate-self-rev">
                            @csrf
                            <div class="overflow-x-auto">
                                <table class="w-full border-collapse border border-gray-300">
                                    ...
                                    <tbody>
                                        {{-- @foreach ($studi['studi'] as $key => $soal) --}}
                                        {{-- @if ($soal['judul'])
                                                    <tr>
                                        ...
                                        @foreach ($studi['skala_penilaian'] as $key => $item)
                                            <tr>
                                                <td class="border border-gray-300 px-4 py-2">{{ $loop->iteration }}</td>
                                                <td class="border border-gray-300 px-4 py-2">{{ $item }}</td>
                                                <td class="border border-gray-300 px-4 py-2 text-center">
                                                    <input type="radio" name="q{{ $key }}" value="4"
                                                        {{ isset($studi['jawaban_instrumen']) && $studi['jawaban_instrumen']['soal_' . $loop->iteration] == 4 ? 'checked' : '' }}>
                                                </td>
                                                <td class="border border-gray-300 px-4 py-2 text-center"><input
                                                        {{ isset($studi['jawaban_instrumen']) && $studi['jawaban_instrumen']['soal_' . $loop->iteration] == 3 ? 'checked' : '' }}
                                                        type="radio" name="q{{ $key }}" value="3"></td>
                                                <td class="border border-gray-300 px-4 py-2 text-center"><input
                                                        {{ isset($studi['jawaban_instrumen']) && $studi['jawaban_instrumen']['soal_' . $loop->iteration] == 2 ? 'checked' : '' }}
                                                        type="radio" name="q{{ $key }}" value="2"></td>
                                                <td class="border border-gray-300 px-4 py-2 text-center"><input
                                                        {{ isset($studi['jawaban_instrumen']) && $studi['jawaban_instrumen']['soal_' . $loop->iteration] == 1 ? 'checked' : '' }}
            ...
            @push('custom-script')
                <script>
                    $('#form-instrumen-accurate-self-rev').submit(function(e) {
                        e.preventDefault();
                        ...
                        axios.post("{{ route('accurate-self-assesment.update', ['accurate_self_assesment' => 1]) }}", {
                                data: jawaban,
                                _method: 'PUT',
                                _token: '{{ csrf_token() }}'
                            })
