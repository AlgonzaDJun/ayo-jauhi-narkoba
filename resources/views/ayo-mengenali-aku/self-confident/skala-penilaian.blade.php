...
@foreach ($self_conf as $studi)
    @if ($studi['nama'] === 'skala penilaian self confidence')
        ...
        <div class="md:flex font-poppins font-Poppins">
            ...
            <div class="space-y-6 md:p-4 rounded-2xl  lg:mx-auto md:mx-5 mt-5 ">
                ...
                @isset($studi['jawaban_instrumen'])
                    <x-congratulations-card title="Selamat!" message="Kamu telah menyelesaikan:"
                        subtitle="Penilaian Capaian Pembelajaran : Self Confidence dengan nilai {{ $studi['jawaban_instrumen']['score'] }}"
                ...
                <div class="indent-7 space-y-3">
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-md max-w-4xl w-full">
                        ...
                        <form method="POST" action="#" id="form-instrumen-self-con-rev">
                            @csrf
            ...
            @push('custom-script')
                <script>
                    $('#form-instrumen-self-con-rev').submit(function(e) {
                        e.preventDefault();
                        ...
                        axios.post("{{ route('self-confidence.update', ['self_confidence' => 1]) }}", {
                                data: jawaban,
                                _method: 'PUT',
                                _token: '{{ csrf_token() }}'
                            })
