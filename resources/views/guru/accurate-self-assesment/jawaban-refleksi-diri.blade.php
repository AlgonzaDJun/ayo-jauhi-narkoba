                ...
                <table class="table" id="table2">
                    <thead>
                        <tr>
                            ...
                            <th>Bagaimana kelebihan Anda dapat membantu dalam menolak menggunakan narkoba? (misal: ketika stres tidak menggunakan narkoba sebagai pelampiasan)</th>
                            <th>Bagaimana Anda dapat memanfaatkan kelebihan ini dalam kehidupan sehari-hari? (misal: mempratikkan mindfulness meditasi)</th>
                            ...
                            <th>Setelah mengetahui kelebihan dan kekurangan diri, rencana apa yang akan Anda lakukan terkait pengembangan diri</th>
                            <th>Rencana jangka panjang?</th>
                            <th>Apakah Anda senang mendengarkan kritik dan saran yang diberikan orang lain? Apa alasannya?</th>
                            ...
                            <th>Apakah Anda meminta orang lain untuk memberikan kritik dan saran tentang perkembangan diri Anda?</th>
                            <th>Apakah Anda menerapkan kritik dan saran yang Anda terima untuk mengembangkan diri menjadi lebih baik?</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($jawaban_accurate_rd as $item)
                            <tr>
                                ...
                                <td>{{ $item->meminta_kritik_dan_sarand }}</td>
                            </tr>
                        @empty
                            <tr>
