...
<head>
    ...
    <meta name="description" content="Mengenal aku : Platform Belajar Self Awareness sebagai Pencegahan Penggunaan Narkoba">
                ...
                @auth
                    ...
                    <div id="userDropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow  ">
                        ...
                        <ul class="py-1 text-sm text-gray-700 " aria-labelledby="avatarButton">
                            <li>
                                <a href="{{ route('ayo-mengenali-aku.edit', ['ayo_mengenali_aku' => 'dashboard']) }}"
